 ...
 * @method Meds      setLagOne()       Sets the current record's "lag_one" value
 * @method Meds      setLagTwo()       Sets the current record's "lag_two" value
 * @method Meds      setLagThree()     Sets the current record's "lag_three" value
 * @method Meds      setLagFour()      Sets the current record's "lag_four" value
 * @method Meds      setLagFive()      Sets the current record's "lag_five" value
 * @method Meds      setLagSix()       Sets the current record's "lag_six" value
 * @method Meds      setLagSeven()     Sets the current record's "lag_seven" value
 * @method Meds      setModel()        Sets the current record's "model" value
 * @method Meds      setNugget()       Sets the current record's "nugget" value
 * @method Meds      setPsill()        Sets the current record's "psill" value
 * @method Meds      setPrange()       Sets the current record's "prange" value
 * @method Meds      setKappa()        Sets the current record's "kappa" value
 * @method Meds      setExpertId()     Sets the current record's "expert_id" value
 * @method Meds      setCasestudyId()  Sets the current record's "casestudy_id" value
 * @method Meds      setExperts()      Sets the current record's "Experts" value
 * @method Meds      setCasestudy()    Sets the current record's "Casestudy" value
 * 
 * @package    eVar
 * @subpackage model
 ...
 */
abstract class BaseMeds extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('meds');
