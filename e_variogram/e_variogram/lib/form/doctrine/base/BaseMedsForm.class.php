...
/**
 * Meds form base class.
 *
 * @method Meds getObject() Returns the current form's model object
 *
 * @package    eVar
 * @subpackage form
 ...
 */
abstract class BaseMedsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('meds[%s]');
