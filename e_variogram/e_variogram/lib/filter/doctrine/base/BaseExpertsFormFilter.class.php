...
/**
 * Experts filter form base class.
 *
 * @package    eVar
 * @subpackage filter
 ...
 */
abstract class BaseExpertsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'expert_name'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('experts_filters[%s]');
