...
<table width="100%">
  <tr>
    <td align="left">
      <a href="<?php echo url_for('empdf/studyarea') ?>" class="small blue button">Click to go back</a>
    </td>
    <td align="right">
      <a href="<?php echo url_for('empdf/new') ?>" class="small blue button"> Click to continue</a>
    </td>
  </tr>
</table>
